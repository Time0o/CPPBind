...
{
  {
    ...
    void * pointee1 = test_pointer_deref(pointer);
    assert(test_pointee_get_state(pointee1) == 1);

    test_pointee_set_state(pointee1, 2);
    void * pointee2 = test_pointer_deref(pointer);
...

  {
    ...
    void * pointee1 = test_pointer_access(pointer);
    assert(test_pointee_get_state(pointee1) == 1);

    test_pointee_set_state(pointee1, 2);
    void * pointee2 = test_pointer_access(pointer);
    assert(test_pointee_get_state(pointee2) == 2);
